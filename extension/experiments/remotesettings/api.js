...
// Autopush (megaphone) STAGE server, used by Remote Settings STAGE
const AUTOPUSH_STAGE = "wss://autopush.stage.mozaws.net";
...
var remotesettings = class extends ExtensionAPI {
  getAPI(context) {
    ...
    Services.prefs.setCharPref("dom.push.serverURL", AUTOPUSH_STAGE);
